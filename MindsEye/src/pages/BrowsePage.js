  ...
  render(){
    ...
    function selectPodcast(index, navigation){
      ...
      navigation.navigate('Podcast', {
        url: Podcasts.urls[index],   //Podcast Link
        uri: Podcasts.uris[index],   //Image Link
        title: Podcasts.titles[index], //Title of podcast
        author: Podcasts.authors[index] //Author
        }
      );
    }
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <ScrollView style={styles.scroll}>
            <Podcast onPress={() => selectPodcast(1, this.props.navigation)}
              title={Podcasts.titles[1]}
              author={Podcasts.authors[1]}
              uri={Podcasts.uris[1]}/>

            <Podcast onPress={() => selectPodcast(2, this.props.navigation)} 
              title={Podcasts.titles[2]}
              author={Podcasts.authors[2]}
              uri={Podcasts.uris[2]}
              />
          
          <Podcast onPress={() => selectPodcast(3, this.props.navigation)} 
              title={Podcasts.titles[3]}
              author={Podcasts.authors[3]}
              uri={Podcasts.uris[3]}/>

            <Podcast onPress={() => selectPodcast(4, this.props.navigation)} 
              title={Podcasts.titles[4]}
              author={Podcasts.authors[4]}
              uri={Podcasts.uris[4]}/>

            <Podcast onPress={() => selectPodcast(5, this.props.navigation)} 
              title={Podcasts.titles[5]}
              author={Podcasts.authors[5]}
              uri={Podcasts.uris[5]}/>
